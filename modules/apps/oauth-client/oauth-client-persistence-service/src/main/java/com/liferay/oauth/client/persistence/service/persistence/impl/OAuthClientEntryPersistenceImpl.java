...
public class OAuthClientEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByC_A_C = createUniqueFinderPath(
			...
			convertNullExtractor(OAuthClientEntry::getAuthServerWellKnownURI),
			convertNullExtractor(OAuthClientEntry::getClientId));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(OAuthClientEntry::getExternalReferenceCode),
			OAuthClientEntry::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:892462662