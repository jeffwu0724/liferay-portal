...
/**
 * The arguments resolver class for retrieving value from MappingEntry.
 *
...
@Component(
	property = {
		"class.name=com.liferay.portal.tools.service.builder.test.compat740.model.impl.MappingEntryImpl",
		"table.name=MappingEntry"
	},
	service = ArgumentsResolver.class
)
public class MappingEntryModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getClassName() {
		return MappingEntryImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return MappingEntryTable.INSTANCE.getTableName();
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:2034571703