...
public class DLFileEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(DLFileEntry::getUuid),
			DLFileEntry::getGroupId);
		...
		_finderPathFetchByG_F_N = createUniqueFinderPath(
			...
			convertNullExtractor(DLFileEntry::getName));
		...
		_finderPathFetchByG_F_FN = createUniqueFinderPath(
			...
			DLFileEntry::getGroupId, DLFileEntry::getFolderId,
			convertNullExtractor(DLFileEntry::getFileName));
		...
		_finderPathFetchByG_F_T = createUniqueFinderPath(
			...
			DLFileEntry::getGroupId, DLFileEntry::getFolderId,
			convertNullExtractor(DLFileEntry::getTitle));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(DLFileEntry::getExternalReferenceCode),
			DLFileEntry::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1100770637