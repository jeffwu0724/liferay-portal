...
public class CPConfigurationListPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			false, convertNullFunction(CPConfigurationList::getUuid),
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullFunction(CPConfigurationList::getExternalReferenceCode),
			CPConfigurationList::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:1027062539