...
public class UserPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByC_SN = createUniqueFinderPath(
			...
			convertNullExtractor(User::getScreenName));
		...
		_finderPathFetchByC_EA = createUniqueFinderPath(
			...
			User::getCompanyId, convertNullExtractor(User::getEmailAddress));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(User::getExternalReferenceCode),
			User::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:20205350