...
public class LVEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G_Head = createUniqueFinderPath(
			...
			convertNullExtractor(LVEntry::getUuid), LVEntry::getGroupId,
			LVEntry::isHead);
		...
		_finderPathFetchByG_UGK_Head = createUniqueFinderPath(
			...
			LVEntry::getGroupId,
			convertNullExtractor(LVEntry::getUniqueGroupKey), LVEntry::isHead);
...
// LIFERAY-SERVICE-BUILDER-HASH:-2011709083