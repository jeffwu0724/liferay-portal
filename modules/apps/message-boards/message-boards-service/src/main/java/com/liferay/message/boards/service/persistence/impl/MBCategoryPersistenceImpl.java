...
public class MBCategoryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(MBCategory::getUuid), MBCategory::getGroupId);
		...
		_finderPathFetchByG_F = createUniqueFinderPath(
			...
			convertNullExtractor(MBCategory::getFriendlyURL));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(MBCategory::getExternalReferenceCode),
			MBCategory::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:909069519