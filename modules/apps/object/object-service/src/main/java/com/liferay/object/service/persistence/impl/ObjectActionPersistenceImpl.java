...
public class ObjectActionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByODI_N = createUniqueFinderPath(
			...
			ObjectAction::getObjectDefinitionId,
			convertNullExtractor(ObjectAction::getName));
		...
		_finderPathFetchByERC_C_ODI = createUniqueFinderPath(
			...
			false, convertNullExtractor(ObjectAction::getExternalReferenceCode),
		...
		_finderPathFetchByODI_A_N_OATK = createUniqueFinderPath(
			...
			convertNullExtractor(ObjectAction::getName),
			convertNullExtractor(ObjectAction::getObjectActionTriggerKey));
...
// LIFERAY-SERVICE-BUILDER-HASH:1164021732