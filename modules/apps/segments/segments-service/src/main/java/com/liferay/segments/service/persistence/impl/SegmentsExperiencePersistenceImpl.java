...
public class SegmentsExperiencePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(SegmentsExperience::getUuid),
			SegmentsExperience::getGroupId);
		...
		_finderPathFetchByG_SEK_P = createUniqueFinderPath(
			...
			SegmentsExperience::getGroupId,
			convertNullExtractor(SegmentsExperience::getSegmentsExperienceKey),
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(SegmentsExperience::getExternalReferenceCode),
			SegmentsExperience::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-805106038