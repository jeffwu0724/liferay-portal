...
public class JournalFolderPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(JournalFolder::getUuid),
			JournalFolder::getGroupId);
		...
		_finderPathFetchByG_N = createUniqueFinderPath(
			...
			convertNullExtractor(JournalFolder::getName));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(JournalFolder::getExternalReferenceCode),
			JournalFolder::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1047078124