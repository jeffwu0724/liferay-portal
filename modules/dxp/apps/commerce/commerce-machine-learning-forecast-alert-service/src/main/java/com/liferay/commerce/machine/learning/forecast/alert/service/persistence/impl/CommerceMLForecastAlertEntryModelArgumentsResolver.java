...
public class CommerceMLForecastAlertEntryModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(
				commerceMLForecastAlertEntryModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				value = commerceMLForecastAlertEntryModelImpl.getColumnValue(
					columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:84144157