...
public class RolePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByC_N = createUniqueFinderPath(
			...
			new String[] {"companyId", "name"}, true, Role::getCompanyId,
			lowerCaseConvertNullExtractor(Role::getName));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(Role::getExternalReferenceCode),
			Role::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-795110529