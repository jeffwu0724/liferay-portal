...
public class CPDefinitionSpecificationOptionValuePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(CPDefinitionSpecificationOptionValue::getUuid),
			CPDefinitionSpecificationOptionValue::getGroupId);
		...
		_finderPathFetchByC_K = createUniqueFinderPath(
			...
			CPDefinitionSpecificationOptionValue::getCPDefinitionId,
			convertNullExtractor(CPDefinitionSpecificationOptionValue::getKey));
...
// LIFERAY-SERVICE-BUILDER-HASH:-1708361848