...
public class SegmentsEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(SegmentsEntry::getUuid),
			SegmentsEntry::getGroupId);
		...
		_finderPathFetchByG_S = createUniqueFinderPath(
			...
			SegmentsEntry::getGroupId,
			convertNullExtractor(SegmentsEntry::getSegmentsEntryKey));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(SegmentsEntry::getExternalReferenceCode),
			SegmentsEntry::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1763108237