...
@Meta.OCD(
	id = "com.liferay.mail.setting.configuration.MailSettingConfiguration",
	localization = "content/Language", name = "mail-settings-configuration-name"
)
public interface MailSettingConfiguration {

	@Meta.AD(name = "enable-pop-server-notifications", required = false)
