...
public class GroupPersistenceImpl
	...
	public List<Group> findByC_GK(
		...
		try (SafeCloseable safeCloseable =
			...
			return _collectionPersistenceFinderByC_GK.find(
				FinderCacheUtil.getFinderCache(),
				new Object[] {companyId, groupKeys}, start, end,
				orderByComparator, useFinderCache);
		}
	}
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			false, convertNullFunction(Group::getUuid), Group::getGroupId);
		...
		_finderPathFetchByC_GK = createUniqueFinderPath(
			...
			new boolean[] {false, false}, false, Group::getCompanyId,
		...
		_finderPathFetchByC_C_C = createUniqueFinderPath(
			...
			new String[] {"companyId", "classNameId", "classPK"},
			new boolean[] {false, false, false}, false, Group::getCompanyId,
...
// LIFERAY-SERVICE-BUILDER-HASH:-1486505450