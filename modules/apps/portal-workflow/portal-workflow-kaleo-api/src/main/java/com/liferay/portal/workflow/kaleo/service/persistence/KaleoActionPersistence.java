...
public interface KaleoActionPersistence
	 ...
	 * @return the matching kaleo actions
	 */
	public default java.util.List<KaleoAction> findByKCN_KCPK_ET(
		String kaleoClassName, long kaleoClassPK, String executionType) {
	 ...
	 * @return the matching kaleo actions
	 */
	public default java.util.List<KaleoAction> findByC_KCN_KCPK_ET(
		long companyId, String kaleoClassName, long kaleoClassPK,
		String executionType) {
...
// LIFERAY-SERVICE-BUILDER-HASH:1489560270