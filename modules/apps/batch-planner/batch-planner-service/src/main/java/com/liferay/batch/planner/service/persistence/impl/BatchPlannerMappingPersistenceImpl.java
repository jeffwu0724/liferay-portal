...
public class BatchPlannerMappingPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByBPPI_EFN_IFN = createUniqueFinderPath(
			...
			convertNullExtractor(BatchPlannerMapping::getExternalFieldName),
			convertNullExtractor(BatchPlannerMapping::getInternalFieldName));
...
// LIFERAY-SERVICE-BUILDER-HASH:2109981411