...
public class ObjectValidationRuleSettingPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByN_V = createUniqueFinderPath(
			...
			convertNullExtractor(ObjectValidationRuleSetting::getName),
			convertNullExtractor(ObjectValidationRuleSetting::getValue));
...
// LIFERAY-SERVICE-BUILDER-HASH:-131271320