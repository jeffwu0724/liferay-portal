...
public class BlogsEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(BlogsEntry::getUuid), BlogsEntry::getGroupId);
		...
		_finderPathFetchByG_UT = createUniqueFinderPath(
			...
			convertNullExtractor(BlogsEntry::getUrlTitle));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(BlogsEntry::getExternalReferenceCode),
...
// LIFERAY-SERVICE-BUILDER-HASH:583669615