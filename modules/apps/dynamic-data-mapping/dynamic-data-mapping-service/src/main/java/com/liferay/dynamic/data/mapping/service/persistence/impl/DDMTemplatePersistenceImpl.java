...
public class DDMTemplatePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(DDMTemplate::getUuid),
			DDMTemplate::getGroupId);
		...
		_finderPathFetchBySmallImageId = createUniqueFinderPath(
			...
			false, DDMTemplate::getSmallImageId);
		...
		_finderPathFetchByG_C_T = createUniqueFinderPath(
			...
			convertNullExtractor(DDMTemplate::getTemplateKey));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(DDMTemplate::getExternalReferenceCode),
			DDMTemplate::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:1048967096