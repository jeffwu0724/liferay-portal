...
public class DLFileEntryTypePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(DLFileEntryType::getUuid),
			DLFileEntryType::getGroupId);
		...
		_finderPathFetchByG_F = createUniqueFinderPath(
			...
			DLFileEntryType::getGroupId,
			convertNullExtractor(DLFileEntryType::getFileEntryTypeKey));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(DLFileEntryType::getExternalReferenceCode),
			DLFileEntryType::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-151646427