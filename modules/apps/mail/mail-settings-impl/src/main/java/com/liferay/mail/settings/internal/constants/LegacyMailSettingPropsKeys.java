...
public class LegacyMailSettingPropsKeys {
	...
	public static final String[] MAIL_SETTING_KEYS = {
		MAIL_SESSION_MAIL_ADVANCED_PROPERTIES, MAIL_SESSION_MAIL_POP3_HOST,
		MAIL_SESSION_MAIL_POP3_PASSWORD, MAIL_SESSION_MAIL_POP3_PORT,
		MAIL_SESSION_MAIL_POP3_USER, MAIL_SESSION_MAIL_SMTP_HOST,
		MAIL_SESSION_MAIL_SMTP_PASSWORD, MAIL_SESSION_MAIL_SMTP_PORT,
		MAIL_SESSION_MAIL_SMTP_STARTTLS_ENABLE, MAIL_SESSION_MAIL_SMTP_USER,
		MAIL_SESSION_MAIL_STORE_PROTOCOL, MAIL_SESSION_MAIL_TRANSPORT_PROTOCOL,
