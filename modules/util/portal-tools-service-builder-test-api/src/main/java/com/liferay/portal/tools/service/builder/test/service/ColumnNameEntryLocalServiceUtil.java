...
/**
 * Provides the local service utility for ColumnNameEntry. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.ColumnNameEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ColumnNameEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.ColumnNameEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ColumnNameEntry addColumnNameEntry(
		ColumnNameEntry columnNameEntry) {

		return getService().addColumnNameEntry(columnNameEntry);
	}
	 ...
	 */
	public static ColumnNameEntry createColumnNameEntry(
		long columnNameEntryId) {

		return getService().createColumnNameEntry(columnNameEntryId);
	}
	 ...
	 */
	public static ColumnNameEntry deleteColumnNameEntry(
		ColumnNameEntry columnNameEntry) {

		return getService().deleteColumnNameEntry(columnNameEntry);
	}
	 ...
	 */
	public static ColumnNameEntry deleteColumnNameEntry(long columnNameEntryId)
		throws PortalException {

		return getService().deleteColumnNameEntry(columnNameEntryId);
	}
	...
	public static ColumnNameEntry fetchColumnNameEntry(long columnNameEntryId) {
		return getService().fetchColumnNameEntry(columnNameEntryId);
	}
	 ...
	 */
	public static List<ColumnNameEntry> getColumnNameEntries(
		int start, int end) {

		return getService().getColumnNameEntries(start, end);
	}
	 ...
	 */
	public static int getColumnNameEntriesCount() {
		return getService().getColumnNameEntriesCount();
	}
	 ...
	 * @throws PortalException if a column name entry with the primary key could not be found
	 */
	public static ColumnNameEntry getColumnNameEntry(long columnNameEntryId)
		throws PortalException {

		return getService().getColumnNameEntry(columnNameEntryId);
	}
	 ...
	 */
	public static ColumnNameEntry updateColumnNameEntry(
		ColumnNameEntry columnNameEntry) {

		return getService().updateColumnNameEntry(columnNameEntry);
	}

	public static ColumnNameEntryLocalService getService() {
		return _service;
	}

	public static void setService(ColumnNameEntryLocalService service) {
		_service = service;
	}

	private static volatile ColumnNameEntryLocalService _service;

}
// LIFERAY-SERVICE-BUILDER-HASH:-1314617339