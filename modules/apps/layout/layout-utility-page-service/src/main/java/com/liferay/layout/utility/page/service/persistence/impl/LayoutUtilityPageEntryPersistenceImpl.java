...
public class LayoutUtilityPageEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(LayoutUtilityPageEntry::getUuid),
			LayoutUtilityPageEntry::getGroupId);
		...
		_finderPathFetchByG_N_T = createUniqueFinderPath(
			...
			LayoutUtilityPageEntry::getGroupId,
			convertNullExtractor(LayoutUtilityPageEntry::getName),
			convertNullExtractor(LayoutUtilityPageEntry::getType));
...
// LIFERAY-SERVICE-BUILDER-HASH:2139651080