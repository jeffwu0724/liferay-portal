...
public class FriendlyURLEntryLocalizationPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByG_C_L_U = createUniqueFinderPath(
			...
			FriendlyURLEntryLocalization::getClassNameId,
			convertNullExtractor(FriendlyURLEntryLocalization::getLanguageId),
			convertNullExtractor(FriendlyURLEntryLocalization::getUrlTitle));
...
// LIFERAY-SERVICE-BUILDER-HASH:-913799784