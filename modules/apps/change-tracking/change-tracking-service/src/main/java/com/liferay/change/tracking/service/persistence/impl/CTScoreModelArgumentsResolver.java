...
/**
 * The arguments resolver class for retrieving value from CTScore.
 *
...
@Component(
	property = {
		"class.name=com.liferay.change.tracking.model.impl.CTScoreImpl",
		"table.name=CTScore"
	},
	service = ArgumentsResolver.class
)
public class CTScoreModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		CTScoreModelImpl ctScoreModelImpl = (CTScoreModelImpl)baseModel;
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= ctScoreModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return CTScoreImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return CTScoreTable.INSTANCE.getTableName();
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:981949160