...
public class CPInstancePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(CPInstance::getUuid), CPInstance::getGroupId);
		...
		_finderPathFetchByC_C = createUniqueFinderPath(
			...
			convertNullExtractor(CPInstance::getCPInstanceUuid));
		...
		_finderPathFetchByCPDI_S = createUniqueFinderPath(
			...
			CPInstance::getCPDefinitionId,
			convertNullExtractor(CPInstance::getSku));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(CPInstance::getExternalReferenceCode),
			CPInstance::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1385745396