...
public class CPMeasurementUnitPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(CPMeasurementUnit::getUuid),
		...
		_finderPathFetchByC_K = createUniqueFinderPath(
			...
			CPMeasurementUnit::getCompanyId,
			lowerCaseConvertNullExtractor(CPMeasurementUnit::getKey));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(CPMeasurementUnit::getExternalReferenceCode),
			CPMeasurementUnit::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:684226332