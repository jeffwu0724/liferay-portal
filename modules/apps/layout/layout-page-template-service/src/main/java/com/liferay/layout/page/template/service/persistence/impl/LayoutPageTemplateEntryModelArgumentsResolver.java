...
@Component(
	property = {
		"class.name=com.liferay.layout.page.template.model.impl.LayoutPageTemplateEntryImpl",
		"table.name=LayoutPageTemplateEntry"
	},
...
public class LayoutPageTemplateEntryModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(
				layoutPageTemplateEntryModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				value = layoutPageTemplateEntryModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
				value = layoutPageTemplateEntryModelImpl.getColumnValue(
					columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:-78841963