...
@Component(
	property = {
		"class.name=com.liferay.object.model.impl.ObjectViewFilterColumnImpl",
		"table.name=ObjectViewFilterColumn"
	},
...
public class ObjectViewFilterColumnModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(
				objectViewFilterColumnModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				value = objectViewFilterColumnModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
				value = objectViewFilterColumnModelImpl.getColumnValue(
					columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:-21908837