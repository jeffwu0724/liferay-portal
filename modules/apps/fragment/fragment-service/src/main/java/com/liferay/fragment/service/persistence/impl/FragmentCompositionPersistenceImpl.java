...
public class FragmentCompositionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(FragmentComposition::getUuid),
			FragmentComposition::getGroupId);
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(FragmentComposition::getExternalReferenceCode),
			FragmentComposition::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:888661150