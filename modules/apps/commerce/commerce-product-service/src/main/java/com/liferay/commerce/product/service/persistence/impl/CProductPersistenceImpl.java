...
public class CProductPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(CProduct::getUuid), CProduct::getGroupId);
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(CProduct::getExternalReferenceCode),
...
// LIFERAY-SERVICE-BUILDER-HASH:2048885123