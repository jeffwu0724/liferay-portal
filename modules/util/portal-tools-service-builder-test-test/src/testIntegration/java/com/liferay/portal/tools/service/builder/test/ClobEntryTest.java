...
public class ClobEntryTest {
	...
	@Test
	public void test() {
		List<ClobEntry> clobEntries = _persistence.findAll(
			QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			OrderByComparatorFactoryUtil.create("ClobEntry", "content", false));

		Assert.assertEquals(
			Arrays.asList(_clobEntry2, _clobEntry1), clobEntries);
	}
