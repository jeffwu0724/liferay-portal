...
public class AssetCategoryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetCategory::getUuid),
			AssetCategory::getGroupId);
		...
		_finderPathFetchByP_N_V = createUniqueFinderPath(
			...
			AssetCategory::getParentCategoryId,
			convertNullExtractor(AssetCategory::getName),
			AssetCategory::getVocabularyId);
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetCategory::getExternalReferenceCode),
			AssetCategory::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-49214083