...
public class StyleBookEntryVersionPersistenceImpl
	...
	public StyleBookEntryVersion findByG_N_Last(
		...
		StyleBookEntryVersion styleBookEntryVersion = fetchByG_N_Last(
			groupId, name, orderByComparator);
	...
	public StyleBookEntryVersion findByG_N_Version_Last(
		...
		StyleBookEntryVersion styleBookEntryVersion = fetchByG_N_Version_Last(
			groupId, name, version, orderByComparator);
	...
	public StyleBookEntryVersion fetchByG_N_Version_Last(
		...
		int count = countByG_N_Version(groupId, name, version);
