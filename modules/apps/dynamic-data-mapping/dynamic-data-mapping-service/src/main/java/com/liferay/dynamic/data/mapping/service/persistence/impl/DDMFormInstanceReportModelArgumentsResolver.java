...
@Component(
	property = {
		"class.name=com.liferay.dynamic.data.mapping.model.impl.DDMFormInstanceReportImpl",
		"table.name=DDMFormInstanceReport"
	},
...
public class DDMFormInstanceReportModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(
				ddmFormInstanceReportModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				value = ddmFormInstanceReportModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
				value = ddmFormInstanceReportModelImpl.getColumnValue(
					columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:920477420