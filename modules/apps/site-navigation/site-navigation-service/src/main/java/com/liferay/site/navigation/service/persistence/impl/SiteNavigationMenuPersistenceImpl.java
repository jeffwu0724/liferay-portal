...
public class SiteNavigationMenuPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(SiteNavigationMenu::getUuid),
			SiteNavigationMenu::getGroupId);
		...
		_finderPathFetchByG_N = createUniqueFinderPath(
			...
			SiteNavigationMenu::getGroupId,
			convertNullExtractor(SiteNavigationMenu::getName));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(SiteNavigationMenu::getExternalReferenceCode),
			SiteNavigationMenu::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-406524003