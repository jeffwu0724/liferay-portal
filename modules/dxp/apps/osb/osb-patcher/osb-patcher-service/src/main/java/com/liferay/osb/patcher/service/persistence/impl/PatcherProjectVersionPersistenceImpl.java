...
public class PatcherProjectVersionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByCommittish = createUniqueFinderPath(
			...
			false, convertNullExtractor(PatcherProjectVersion::getCommittish));
		...
		_finderPathFetchByName = createUniqueFinderPath(
			...
			convertNullExtractor(PatcherProjectVersion::getName));
...
// LIFERAY-SERVICE-BUILDER-HASH:335947196