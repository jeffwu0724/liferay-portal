...
public class SiteFriendlyURLPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(SiteFriendlyURL::getUuid),
		...
		_finderPathFetchByC_F = createUniqueFinderPath(
			...
			convertNullExtractor(SiteFriendlyURL::getFriendlyURL));
		...
		_finderPathFetchByG_C_L = createUniqueFinderPath(
			...
			convertNullExtractor(SiteFriendlyURL::getLanguageId));
...
// LIFERAY-SERVICE-BUILDER-HASH:2069998308