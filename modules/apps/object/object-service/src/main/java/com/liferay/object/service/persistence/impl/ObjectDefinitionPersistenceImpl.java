...
public class ObjectDefinitionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByClassName = createUniqueFinderPath(
			...
			false, convertNullExtractor(ObjectDefinition::getClassName));
		...
		_finderPathFetchByC_C = createUniqueFinderPath(
			...
			ObjectDefinition::getCompanyId,
			convertNullExtractor(ObjectDefinition::getClassName));
		...
		_finderPathFetchByC_N = createUniqueFinderPath(
			...
			ObjectDefinition::getCompanyId,
			convertNullExtractor(ObjectDefinition::getName));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(ObjectDefinition::getExternalReferenceCode),
			ObjectDefinition::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-312283935