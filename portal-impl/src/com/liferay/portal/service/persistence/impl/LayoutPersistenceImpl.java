...
public class LayoutPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G_P = createUniqueFinderPath(
			...
			convertNullExtractor(Layout::getUuid), Layout::getGroupId,
		...
		_collectionPersistenceFinderByG_T = new CollectionPersistenceFinder<>(
			...
			new FinderColumn<>(
				...
				Layout::getGroupId),
			new FinderColumn<>(
				"layout.", "type", FinderColumn.Type.STRING, "=", true, true,
				Layout::getType));
		...
		_finderPathFetchByG_P_F = createUniqueFinderPath(
			...
			convertNullExtractor(Layout::getFriendlyURL));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(Layout::getExternalReferenceCode),
			Layout::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-855260407