...
public class ThirdPartyLibraryDependenciesTest {
	...
	public void testIfExistedUnusedExportPackageFromSharedDependencies() {
		...
		for (Bundle curBundle : bundleContext.getBundles()) {
			...
			for (String exportPackageFromManifest :
				...
				if (_whitelist.contains(exportPackageFromManifest)) {
					continue;
				}
		...
		Assert.assertTrue(
			"These bundles have unused export-package, please update: \n" +
	...
	private static final Set<String> _whitelist = SetUtil.fromArray(
