...
public class WikiPagePersistenceImpl
	...
	public List<WikiPage> findByN_H_P(
		...
		try (SafeCloseable safeCloseable =
			...
			return _collectionPersistenceFinderByN_H_P.find(
				finderCache, new Object[] {nodeId, head, parentTitle}, start,
	...
	public List<WikiPage> findByN_H_R(
		...
		try (SafeCloseable safeCloseable =
			...
			return _collectionPersistenceFinderByN_H_R.find(
				finderCache, new Object[] {nodeId, head, redirectTitle}, start,
				end, orderByComparator, useFinderCache);
		}
	}
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(WikiPage::getUuid), WikiPage::getGroupId);
		...
		_finderPathFetchByG_ERC_V = createUniqueFinderPath(
			...
			WikiPage::getGroupId,
			convertNullExtractor(WikiPage::getExternalReferenceCode),
			WikiPage::getVersion);
		...
		_finderPathFetchByN_T_V = createUniqueFinderPath(
			...
			WikiPage::getNodeId,
			lowerCaseConvertNullExtractor(WikiPage::getTitle),
			WikiPage::getVersion);
...
// LIFERAY-SERVICE-BUILDER-HASH:537032726