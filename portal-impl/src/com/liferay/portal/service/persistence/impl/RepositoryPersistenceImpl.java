...
public class RepositoryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(Repository::getUuid), Repository::getGroupId);
		...
		_finderPathFetchByG_N_P = createUniqueFinderPath(
			...
			Repository::getGroupId, convertNullExtractor(Repository::getName),
			convertNullExtractor(Repository::getPortletId));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(Repository::getExternalReferenceCode),
...
// LIFERAY-SERVICE-BUILDER-HASH:-353688366