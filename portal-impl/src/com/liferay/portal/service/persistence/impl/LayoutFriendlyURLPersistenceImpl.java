...
public class LayoutFriendlyURLPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(LayoutFriendlyURL::getUuid),
		...
		_finderPathFetchByP_L = createUniqueFinderPath(
			...
			convertNullExtractor(LayoutFriendlyURL::getLanguageId));
		...
		_finderPathFetchByG_P_F_L = createUniqueFinderPath(
			...
			LayoutFriendlyURL::isPrivateLayout,
			convertNullExtractor(LayoutFriendlyURL::getFriendlyURL),
			convertNullExtractor(LayoutFriendlyURL::getLanguageId));
...
// LIFERAY-SERVICE-BUILDER-HASH:1455156327