...
public class LayoutPageTemplateCollectionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(LayoutPageTemplateCollection::getUuid),
			LayoutPageTemplateCollection::getGroupId);
		...
		_finderPathFetchByG_P_N_T = createUniqueFinderPath(
			...
			LayoutPageTemplateCollection::
				getParentLayoutPageTemplateCollectionId,
			convertNullExtractor(LayoutPageTemplateCollection::getName),
			LayoutPageTemplateCollection::getType);
...
// LIFERAY-SERVICE-BUILDER-HASH:1748020139