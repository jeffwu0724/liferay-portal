...
public class OpenIdConnectSessionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByU_I = createUniqueFinderPath(
			...
			convertNullExtractor(OpenIdConnectSession::getIssuer));
		...
		_finderPathFetchByI_S = createUniqueFinderPath(
			...
			convertNullExtractor(OpenIdConnectSession::getIssuer),
			convertNullExtractor(OpenIdConnectSession::getSessionId));
		...
		_finderPathFetchByU_A_C = createUniqueFinderPath(
			...
			convertNullExtractor(
				OpenIdConnectSession::getAuthServerWellKnownURI),
			convertNullExtractor(OpenIdConnectSession::getClientId));
...
// LIFERAY-SERVICE-BUILDER-HASH:188923469