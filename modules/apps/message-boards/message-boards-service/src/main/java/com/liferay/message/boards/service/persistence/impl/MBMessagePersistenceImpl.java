...
public class MBMessagePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(MBMessage::getUuid), MBMessage::getGroupId);
		...
		_finderPathFetchByG_US = createUniqueFinderPath(
			...
			convertNullExtractor(MBMessage::getUrlSubject));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(MBMessage::getExternalReferenceCode),
			MBMessage::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-997954223