...
public class DateEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newDateEntry.setDateValue(RandomTestUtil.nextDate());
		...
		Assert.assertEquals(
			Time.getShortTimestamp(existingDateEntry.getDateValue()),
			Time.getShortTimestamp(newDateEntry.getDateValue()));
	}
	...
	protected OrderByComparator<DateEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"DateEntry", "dateEntryId", true, "dateValue", true);
	}
	...
	protected DateEntry addDateEntry() throws Exception {
		...
		dateEntry.setDateValue(RandomTestUtil.nextDate());
...
// LIFERAY-SERVICE-BUILDER-HASH:-806922242