...
public class ColumnNameEntryPersistenceTest {
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		ActionableDynamicQuery actionableDynamicQuery =
			ColumnNameEntryLocalServiceUtil.getActionableDynamicQuery();

		actionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<ColumnNameEntry>() {

				@Override
				public void performAction(ColumnNameEntry columnNameEntry) {
					Assert.assertNotNull(columnNameEntry);
...
// LIFERAY-SERVICE-BUILDER-HASH:401235336