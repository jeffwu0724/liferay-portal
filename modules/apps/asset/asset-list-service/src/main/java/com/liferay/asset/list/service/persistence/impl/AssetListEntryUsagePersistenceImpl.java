...
public class AssetListEntryUsagePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetListEntryUsage::getUuid),
		...
		_finderPathFetchByG_C_CK_CT_K_P = createUniqueFinderPath(
			...
			AssetListEntryUsage::getClassNameId,
			convertNullExtractor(AssetListEntryUsage::getContainerKey),
			AssetListEntryUsage::getContainerType,
			convertNullExtractor(AssetListEntryUsage::getKey),
...
// LIFERAY-SERVICE-BUILDER-HASH:1563443461