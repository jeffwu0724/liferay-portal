...
public class CommerceTermEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByC_N = createUniqueFinderPath(
			...
			CommerceTermEntry::getCompanyId,
			convertNullExtractor(CommerceTermEntry::getName));
		...
		_finderPathFetchByC_P_T = createUniqueFinderPath(
			...
			convertNullExtractor(CommerceTermEntry::getType));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(CommerceTermEntry::getExternalReferenceCode),
			CommerceTermEntry::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-742352814