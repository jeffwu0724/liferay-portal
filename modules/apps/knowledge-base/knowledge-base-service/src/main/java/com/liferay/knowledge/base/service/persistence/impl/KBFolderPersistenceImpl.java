...
public class KBFolderPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(KBFolder::getUuid), KBFolder::getGroupId);
		...
		_finderPathFetchByG_P_N = createUniqueFinderPath(
			...
			convertNullExtractor(KBFolder::getName));
		...
		_finderPathFetchByG_P_UT = createUniqueFinderPath(
			...
			KBFolder::getGroupId, KBFolder::getParentKBFolderId,
			convertNullExtractor(KBFolder::getUrlTitle));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(KBFolder::getExternalReferenceCode),
			KBFolder::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:927930955