...
/**
 * The arguments resolver class for retrieving value from KBArticle.
 *
...
public class KBArticleModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		KBArticleModelImpl kbArticleModelImpl = (KBArticleModelImpl)baseModel;
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= kbArticleModelImpl.getColumnBitmask(
					columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(KBArticlePersistenceImpl.
	...
	static {
		...
		orderByColumnsBitmask |= KBArticleModelImpl.getColumnBitmask(
			"modifiedDate");
...
// LIFERAY-SERVICE-BUILDER-HASH:1902189413