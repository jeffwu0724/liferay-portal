...
public class CTSContentPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByC_R_P_V_S = createUniqueFinderPath(
			...
			convertNullExtractor(CTSContent::getPath),
			convertNullExtractor(CTSContent::getVersion),
			convertNullExtractor(CTSContent::getStoreType));
...
// LIFERAY-SERVICE-BUILDER-HASH:-1647666162