...
public class ObjectRelationshipPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByDTN_R = createUniqueFinderPath(
			...
			convertNullExtractor(ObjectRelationship::getDBTableName),
		...
		_finderPathFetchByERC_C_ODI1 = createUniqueFinderPath(
			...
			false,
			convertNullExtractor(ObjectRelationship::getExternalReferenceCode),
		...
		_finderPathFetchByODI1_ODI2_N_R_T = createUniqueFinderPath(
			...
			ObjectRelationship::getObjectDefinitionId2,
			convertNullExtractor(ObjectRelationship::getName),
			ObjectRelationship::isReverse,
			convertNullExtractor(ObjectRelationship::getType));
...
// LIFERAY-SERVICE-BUILDER-HASH:1047246312