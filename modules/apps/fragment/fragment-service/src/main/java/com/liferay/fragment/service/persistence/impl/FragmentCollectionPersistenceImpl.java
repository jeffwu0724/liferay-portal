...
public class FragmentCollectionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(FragmentCollection::getUuid),
			FragmentCollection::getGroupId);
		...
		_finderPathFetchByG_FCK = createUniqueFinderPath(
			...
			FragmentCollection::getGroupId,
			convertNullExtractor(FragmentCollection::getFragmentCollectionKey));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(FragmentCollection::getExternalReferenceCode),
			FragmentCollection::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:650472814