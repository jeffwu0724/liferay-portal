...
public class AssetVocabularyPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetVocabulary::getUuid),
			AssetVocabulary::getGroupId);
		...
		_finderPathFetchByG_N = createUniqueFinderPath(
			...
			AssetVocabulary::getGroupId,
			lowerCaseConvertNullExtractor(AssetVocabulary::getName));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetVocabulary::getExternalReferenceCode),
			AssetVocabulary::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:1153516440