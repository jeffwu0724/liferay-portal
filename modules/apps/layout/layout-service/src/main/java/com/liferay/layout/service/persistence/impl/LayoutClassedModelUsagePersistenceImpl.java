...
public class LayoutClassedModelUsagePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(LayoutClassedModelUsage::getUuid),
		...
		_finderPathFetchByG_CERC_CN_CPK_CK_CT_P = createUniqueFinderPath(
			...
			LayoutClassedModelUsage::getClassNameId,
			LayoutClassedModelUsage::getClassPK,
			convertNullExtractor(LayoutClassedModelUsage::getContainerKey),
			LayoutClassedModelUsage::getContainerType,
...
// LIFERAY-SERVICE-BUILDER-HASH:541226392