...
@Component(
	property = {
		"class.name=com.liferay.segments.model.impl.SegmentsEntryRelImpl",
		"table.name=SegmentsEntryRel"
	},
...
public class SegmentsEntryRelModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(segmentsEntryRelModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				value = segmentsEntryRelModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
				value = segmentsEntryRelModelImpl.getColumnValue(columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:1976475689