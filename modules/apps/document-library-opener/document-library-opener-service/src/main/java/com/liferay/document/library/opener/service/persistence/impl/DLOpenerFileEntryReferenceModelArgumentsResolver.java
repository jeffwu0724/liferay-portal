...
/**
 * The arguments resolver class for retrieving value from DLOpenerFileEntryReference.
 *
...
public class DLOpenerFileEntryReferenceModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(
				dlOpenerFileEntryReferenceModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				value = dlOpenerFileEntryReferenceModelImpl.getColumnValue(
					columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:-843727124