			...
			if (Objects.equals(jsonParserFieldName, "actions")) {
				...
				if (jsonParserFieldValue != null) {
					...
					for(String string : toStrings((Object[])jsonParserFieldValue)){
						...
						Map<String, Object> jsonParserFieldValuesMap = parseToMap(string);

						for(Object object : (Object[])jsonParserFieldValuesMap.get("facetValues")){
							Map<String, Object> facetValueMap = parseToMap((String)object);
				...
				if (jsonParserFieldValue != null) {
					...
					for(String string : toStrings((Object[])jsonParserFieldValue)){
						items.add(_toDTOFunction.apply(string));
					}
