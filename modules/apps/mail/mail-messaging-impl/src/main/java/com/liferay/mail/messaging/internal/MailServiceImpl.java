...
public class MailServiceImpl
	...
	private Session _createMailSession() {
		...
		properties.put(
			"mail.store.protocol",
			mailSettingCompanyConfiguration.storeProtocol());
		...
		properties.put(
			"mail.pop3.host",
			mailSettingCompanyConfiguration.incomingPOPServer());
		properties.put(
			"mail.pop3.password",
			mailSettingCompanyConfiguration.popPassword());
		properties.put(
			"mail.pop3.port",
			mailSettingCompanyConfiguration.incomingPOPPort());
		properties.put(
			"mail.pop3.user", mailSettingCompanyConfiguration.popUserName());
		...
		properties.put(
			"mail.smtp.password",
			mailSettingCompanyConfiguration.smtpPassword());
		properties.put(
			"mail.smtp.port",
			mailSettingCompanyConfiguration.outgoingSMTPPort());
		properties.put(
			...
			mailSettingCompanyConfiguration.enableStartTLS());
		properties.put(
			"mail.smtp.user", mailSettingCompanyConfiguration.smtpUserName());
