...
public class OAuth2ScopeGrantPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByC_O_A_B_S = createUniqueFinderPath(
			...
			OAuth2ScopeGrant::getOAuth2ApplicationScopeAliasesId,
			convertNullExtractor(OAuth2ScopeGrant::getApplicationName),
			convertNullExtractor(OAuth2ScopeGrant::getBundleSymbolicName),
			convertNullExtractor(OAuth2ScopeGrant::getScope));
...
// LIFERAY-SERVICE-BUILDER-HASH:1673499016