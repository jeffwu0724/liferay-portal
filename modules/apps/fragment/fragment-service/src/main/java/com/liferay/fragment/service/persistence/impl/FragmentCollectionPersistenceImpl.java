...
public class FragmentCollectionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			false, convertNullFunction(FragmentCollection::getUuid),
			FragmentCollection::getGroupId);
		...
		_finderPathFetchByG_FCK = createUniqueFinderPath(
			...
			new String[] {"groupId", "fragmentCollectionKey"},
			new boolean[] {false, false}, false, FragmentCollection::getGroupId,
...
// LIFERAY-SERVICE-BUILDER-HASH:-1029135282