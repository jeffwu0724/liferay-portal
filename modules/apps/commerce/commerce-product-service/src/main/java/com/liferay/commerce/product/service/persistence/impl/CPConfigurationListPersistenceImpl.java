...
public class CPConfigurationListPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(CPConfigurationList::getUuid),
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(CPConfigurationList::getExternalReferenceCode),
			CPConfigurationList::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1080608026