...
public class SamlSpAuthRequestPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchBySIEI_SSARK = createUniqueFinderPath(
			...
			convertNullExtractor(SamlSpAuthRequest::getSamlIdpEntityId),
			convertNullExtractor(SamlSpAuthRequest::getSamlSpAuthRequestKey));
...
// LIFERAY-SERVICE-BUILDER-HASH:-954779459