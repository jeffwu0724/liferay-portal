...
public class DDLRecordSetPersistenceImpl
	...
	public List<DDLRecordSet> findByDDMStructureId(
		...
		try (SafeCloseable safeCloseable =
			...
			return _collectionPersistenceFinderByDDMStructureId.find(
				finderCache, new Object[] {new long[] {DDMStructureId}}, start,
	...
	public List<DDLRecordSet> findByDDMStructureId(
		...
		try (SafeCloseable safeCloseable =
			...
			return _collectionPersistenceFinderByDDMStructureId.find(
				finderCache,
				new Object[] {ArrayUtil.sortedUnique(DDMStructureIds)}, start,
				end, orderByComparator, useFinderCache);
		}
	}
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			false, convertNullFunction(DDLRecordSet::getUuid),
		...
		_finderPathFetchByG_R = createUniqueFinderPath(
			...
			new boolean[] {false, false}, false, DDLRecordSet::getGroupId,
...
// LIFERAY-SERVICE-BUILDER-HASH:86444456