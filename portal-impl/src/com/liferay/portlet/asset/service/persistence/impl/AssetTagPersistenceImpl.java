...
public class AssetTagPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetTag::getUuid), AssetTag::getGroupId);
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetTag::getExternalReferenceCode),
			AssetTag::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1755150115