...
public class WikiNodePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(WikiNode::getUuid), WikiNode::getGroupId);
		...
		_finderPathFetchByG_N = createUniqueFinderPath(
			...
			convertNullExtractor(WikiNode::getName));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(WikiNode::getExternalReferenceCode),
			WikiNode::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:1850161919