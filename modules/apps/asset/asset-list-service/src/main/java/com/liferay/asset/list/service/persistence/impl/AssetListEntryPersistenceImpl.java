...
public class AssetListEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetListEntry::getUuid),
			AssetListEntry::getGroupId);
		...
		_finderPathFetchByG_ALEK = createUniqueFinderPath(
			...
			AssetListEntry::getGroupId,
			convertNullExtractor(AssetListEntry::getAssetListEntryKey));
		...
		_finderPathFetchByG_T = createUniqueFinderPath(
			...
			AssetListEntry::getGroupId,
			convertNullExtractor(AssetListEntry::getTitle));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(AssetListEntry::getExternalReferenceCode),
			AssetListEntry::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:2030306444