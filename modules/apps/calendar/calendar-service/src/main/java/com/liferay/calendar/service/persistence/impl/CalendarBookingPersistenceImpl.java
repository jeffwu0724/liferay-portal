...
public class CalendarBookingPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(CalendarBooking::getUuid),
			CalendarBooking::getGroupId);
		...
		_finderPathFetchByC_V = createUniqueFinderPath(
			...
			CalendarBooking::getCalendarId,
			convertNullExtractor(CalendarBooking::getVEventUid));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(CalendarBooking::getExternalReferenceCode),
			CalendarBooking::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:1691420675