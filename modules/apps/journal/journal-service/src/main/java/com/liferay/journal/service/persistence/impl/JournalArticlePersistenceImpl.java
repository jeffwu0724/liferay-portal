...
public class JournalArticlePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(JournalArticle::getUuid),
		...
		_finderPathFetchByG_ERC_V = createUniqueFinderPath(
			...
			JournalArticle::getGroupId,
			convertNullExtractor(JournalArticle::getExternalReferenceCode),
		...
		_finderPathFetchByG_A_V = createUniqueFinderPath(
			...
			JournalArticle::getGroupId,
			convertNullExtractor(JournalArticle::getArticleId),
			JournalArticle::getVersion);
...
// LIFERAY-SERVICE-BUILDER-HASH:1893187254