...
@Component(
	property = {
		"class.name=com.liferay.commerce.product.model.impl.CPDefinitionOptionValueRelImpl",
		"table.name=CPDefinitionOptionValueRel"
	},
...
public class CPDefinitionOptionValueRelModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(
				cpDefinitionOptionValueRelModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				value = cpDefinitionOptionValueRelModelImpl.getColumnValue(
					columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:-851208929