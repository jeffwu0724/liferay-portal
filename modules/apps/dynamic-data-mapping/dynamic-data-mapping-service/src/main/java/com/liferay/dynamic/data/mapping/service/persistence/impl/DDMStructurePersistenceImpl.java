...
public class DDMStructurePersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(DDMStructure::getUuid),
		...
		_finderPathFetchByERC_G_C = createUniqueFinderPath(
			...
			new String[] {"externalReferenceCode", "groupId", "classNameId"},
			false, convertNullExtractor(DDMStructure::getExternalReferenceCode),
		...
		_finderPathFetchByG_C_S = createUniqueFinderPath(
			...
			DDMStructure::getGroupId, DDMStructure::getClassNameId,
			convertNullExtractor(DDMStructure::getStructureKey));
...
// LIFERAY-SERVICE-BUILDER-HASH:2139702055