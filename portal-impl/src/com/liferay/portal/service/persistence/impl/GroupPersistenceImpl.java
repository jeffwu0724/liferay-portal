...
public class GroupPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(Group::getUuid), Group::getGroupId);
		...
		_finderPathFetchByC_GK = createUniqueFinderPath(
			...
			convertNullExtractor(Group::getGroupKey));
		...
		_finderPathFetchByC_F = createUniqueFinderPath(
			...
			Group::getCompanyId, convertNullExtractor(Group::getFriendlyURL));
		...
		_finderPathFetchByC_C_L_GK = createUniqueFinderPath(
			...
			Group::getLiveGroupId, convertNullExtractor(Group::getGroupKey));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(Group::getExternalReferenceCode),
			Group::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-561735938