...
public class DLFolderPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(DLFolder::getUuid), DLFolder::getGroupId);
		...
		_finderPathFetchByG_P_N = createUniqueFinderPath(
			...
			convertNullExtractor(DLFolder::getName));
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(DLFolder::getExternalReferenceCode),
			DLFolder::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:1360517868