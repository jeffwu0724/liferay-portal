...
public class CommerceSubscriptionEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(CommerceSubscriptionEntry::getUuid),
		...
		_finderPathFetchByC_C_C = createUniqueFinderPath(
			...
			false,
			convertNullExtractor(CommerceSubscriptionEntry::getCPInstanceUuid),
...
// LIFERAY-SERVICE-BUILDER-HASH:-2022665191