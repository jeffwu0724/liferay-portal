...
public class SegmentsExperimentPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(SegmentsExperiment::getUuid),
		...
		_finderPathFetchByG_S = createUniqueFinderPath(
			...
			SegmentsExperiment::getGroupId,
			convertNullExtractor(SegmentsExperiment::getSegmentsExperimentKey));
...
// LIFERAY-SERVICE-BUILDER-HASH:1238800925