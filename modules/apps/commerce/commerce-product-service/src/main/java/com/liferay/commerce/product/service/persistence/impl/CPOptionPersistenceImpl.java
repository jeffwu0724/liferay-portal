...
public class CPOptionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByC_K = createUniqueFinderPath(
			...
			new String[] {"companyId", "key_"}, false, CPOption::getCompanyId,
			convertNullExtractor(CPOption::getKey));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(CPOption::getExternalReferenceCode),
...
// LIFERAY-SERVICE-BUILDER-HASH:1662003152