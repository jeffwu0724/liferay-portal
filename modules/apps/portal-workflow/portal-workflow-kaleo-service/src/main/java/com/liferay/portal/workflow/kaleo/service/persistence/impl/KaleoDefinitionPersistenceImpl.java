...
public class KaleoDefinitionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(KaleoDefinition::getUuid),
		...
		_finderPathFetchByC_N = createUniqueFinderPath(
			...
			KaleoDefinition::getCompanyId,
			convertNullExtractor(KaleoDefinition::getName));
		...
		_finderPathFetchByERC_C = createUniqueFinderPath(
			...
			convertNullExtractor(KaleoDefinition::getExternalReferenceCode),
			KaleoDefinition::getCompanyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:1672674233