...
public class DEDataDefinitionFieldLinkPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(DEDataDefinitionFieldLink::getUuid),
		...
		_finderPathFetchByC_C_DDMSI_F = createUniqueFinderPath(
			...
			DEDataDefinitionFieldLink::getDdmStructureId,
			convertNullExtractor(DEDataDefinitionFieldLink::getFieldName));
...
// LIFERAY-SERVICE-BUILDER-HASH:-2086854120