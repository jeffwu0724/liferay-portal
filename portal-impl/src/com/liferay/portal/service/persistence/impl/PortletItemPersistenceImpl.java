...
public class PortletItemPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByG_N_P_C = createUniqueFinderPath(
			...
			PortletItem::getGroupId,
			lowerCaseConvertNullExtractor(PortletItem::getName),
			convertNullExtractor(PortletItem::getPortletId),
...
// LIFERAY-SERVICE-BUILDER-HASH:-1282159486