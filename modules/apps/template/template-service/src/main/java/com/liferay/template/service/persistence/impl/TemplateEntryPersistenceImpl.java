...
public class TemplateEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = createUniqueFinderPath(
			...
			convertNullExtractor(TemplateEntry::getUuid),
			TemplateEntry::getGroupId);
		...
		_finderPathFetchByDDMTemplateId = createUniqueFinderPath(
			...
			false, TemplateEntry::getDDMTemplateId);
		...
		_finderPathFetchByERC_G = createUniqueFinderPath(
			...
			convertNullExtractor(TemplateEntry::getExternalReferenceCode),
			TemplateEntry::getGroupId);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1580881788