...
/**
 * The arguments resolver class for retrieving value from KaleoTransition.
 *
...
@Component(
	property = {
		"class.name=com.liferay.portal.workflow.kaleo.model.impl.KaleoTransitionImpl",
		"table.name=KaleoTransition"
	},
	service = ArgumentsResolver.class
)
public class KaleoTransitionModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(kaleoTransitionModelImpl, finderPath, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				value = kaleoTransitionModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
				value = kaleoTransitionModelImpl.getColumnValue(columnName);
			}
...
// LIFERAY-SERVICE-BUILDER-HASH:1132646193